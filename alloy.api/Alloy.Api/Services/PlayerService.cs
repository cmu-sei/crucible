...
namespace Alloy.Api.Services
{
    public interface IPlayerService
    {
        ...
        Task<ApiError> DeleteExerciseAsync(Guid exerciseId, CancellationToken ct);
    ...
    public class PlayerService : IPlayerService 
    {
        ...
        public async Task<ApiError> DeleteExerciseAsync(Guid exerciseId, CancellationToken ct)
        {
            return await _s3PlayerApiClient.DeleteExerciseAsync(exerciseId);
        }
