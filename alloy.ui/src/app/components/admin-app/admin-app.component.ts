...
export class AdminAppComponent implements OnInit {
  ...
  public definitionsText = 'Definitions';
  public implementationsText = 'Implementations';
  public showStatus = 'Definitions';
  public shouldUpdateDefinitions: Subject<boolean> = new Subject();
  public shouldUpdateImplementations: Subject<boolean> = new Subject();
   ...
   */
  adminGotoDefinitions(): void {
    this.showStatus = this.definitionsText;
  }

  /**
   * Sets the display to Users
   */
  adminGotoImplementations(): void {
    this.showStatus = this.implementationsText;
  }
