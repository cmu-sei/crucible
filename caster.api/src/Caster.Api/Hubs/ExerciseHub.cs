...
namespace Caster.Api.Hubs
{
    ...
    public class ExerciseHub : Hub
    {
        ...
        public ExerciseHub(IOutputService outputService, CasterContext db)
        {
            _outputService = outputService;
            _db = db;
        }

        public async Task JoinExercise(Guid exerciseId)
        {
            await Groups.AddToGroupAsync(Context.ConnectionId, exerciseId.ToString());
        }

        public async Task LeaveExercise(Guid exerciseId)
        {
            await Groups.RemoveFromGroupAsync(Context.ConnectionId, exerciseId.ToString());
        }
