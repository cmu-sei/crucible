...
import { User, Permission, UserPermission } from '../../../generated/caster-api';
...
export class UsersComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.isLoading$ = this.userQuery.selectLoading() || this.permissionQuery.selectLoading();
  }
  ...
  addUserPermission(userPermission: UserPermission) {
    this.userService.addUserPermission(userPermission.userId, userPermission.permissionId);
  }

  removeUserPermission(userPermission: UserPermission) {
    this.userService.removeUserPermission(userPermission.userId, userPermission.permissionId);
  }
