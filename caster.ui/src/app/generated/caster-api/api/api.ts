...
export const APIS = [AppliesService, DirectoriesService, ExercisesService, FilesService, HostsService, ModulesService, PermissionsService, PlansService, ResourcesService, RunsService, UserPermissionsService, UsersService, WorkspacesService];
