...
export class DirectoriesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getDirectoriesByExercise(exerciseId: string, IncludeDescendants?: boolean, IncludeRelated?: boolean, IncludeFileContent?: boolean, observe?: 'body', reportProgress?: boolean): Observable<Array<Directory>>;
    public getDirectoriesByExercise(exerciseId: string, IncludeDescendants?: boolean, IncludeRelated?: boolean, IncludeFileContent?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Directory>>>;
    public getDirectoriesByExercise(exerciseId: string, IncludeDescendants?: boolean, IncludeRelated?: boolean, IncludeFileContent?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Directory>>>;
    public getDirectoriesByExercise(exerciseId: string, IncludeDescendants?: boolean, IncludeRelated?: boolean, IncludeFileContent?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (exerciseId === null || exerciseId === undefined) {
            throw new Error('Required parameter exerciseId was null or undefined when calling getDirectoriesByExercise.');
        }
        ...
        return this.httpClient.get<Array<Directory>>(`${this.configuration.basePath}/api/exercises/${encodeURIComponent(String(exerciseId))}/directories`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getDirectory(id: string, Id?: string, IncludeRelated?: boolean, IncludeFileContent?: boolean, observe?: 'body', reportProgress?: boolean): Observable<Directory>;
    public getDirectory(id: string, Id?: string, IncludeRelated?: boolean, IncludeFileContent?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Directory>>;
    public getDirectory(id: string, Id?: string, IncludeRelated?: boolean, IncludeFileContent?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Directory>>;
    public getDirectory(id: string, Id?: string, IncludeRelated?: boolean, IncludeFileContent?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
