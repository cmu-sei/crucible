...
export class PermissionsService {
  ...
  public getAllPermissions(
    ...
    return this.httpClient.get<Array<Permission>>(
      `${this.configuration.basePath}/api/permissions`,
      {
  ...
  public getMyPermissions(
    ...
    return this.httpClient.get<Array<Permission>>(
      `${this.configuration.basePath}/api/permissions/mine`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  public getPermission(
    ...
    return this.httpClient.get<Permission>(
      `${this.configuration.basePath}/api/permissions/${encodeURIComponent(
        String(id)
      )}`,
      {
        withCredentials: this.configuration.withCredentials,
  ...
  public getPermissionsByUser(
    ...
    if (userId === null || userId === undefined) {
      throw new Error(
        'Required parameter userId was null or undefined when calling getPermissionsByUser.'
      );
    }
