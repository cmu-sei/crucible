...
export class ProjectsService {
  ...
  public editProject(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling editProject.'
      );
    }
  ...
  public exportProject(
    ...
    return this.httpClient.get(
      ...
      }/api/projects/projects/${encodeURIComponent(String(id))}/actions/export`,
      {
  ...
  public importProject(
    ...
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<ImportProjectResult>;
  public importProject(
    id: string,
    PreserveIds?: boolean,
    Archive?: Blob,
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<ImportProjectResult>>;
  public importProject(
    id: string,
    PreserveIds?: boolean,
    Archive?: Blob,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<ImportProjectResult>>;
  public importProject(
    id: string,
    PreserveIds?: boolean,
    Archive?: Blob,
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling importProject.'
      );
    }
    ...
    return this.httpClient.post<ImportProjectResult>(
      `${
        this.configuration.basePath
      }/api/projects/projects/${encodeURIComponent(String(id))}/actions/import`,
