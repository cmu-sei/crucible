...
export class RunsService {
  ...
  public createRun(
    ...
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<Run>>;
  public createRun(
    CreateRunCommand?: CreateRunCommand,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<Run>>;
  public createRun(
    CreateRunCommand?: CreateRunCommand,
    observe: any = 'body',
    ...
    return this.httpClient.post<Run>(
      `${this.configuration.basePath}/api/runs`,
      CreateRunCommand,
      {
  ...
  public getRun(
    ...
    return this.httpClient.get<Run>(
      `${this.configuration.basePath}/api/runs/${encodeURIComponent(
        String(id)
      )}`,
      {
  ...
  public getRuns(
    ...
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<Array<Run>>>;
  public getRuns(
    ActiveOnly?: boolean,
    Limit?: number,
    IncludePlan?: boolean,
    ...
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<Run>>>;
  public getRuns(
    ActiveOnly?: boolean,
    Limit?: number,
    IncludePlan?: boolean,
    ...
    return this.httpClient.get<Array<Run>>(
      `${this.configuration.basePath}/api/runs`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
  ...
  public getRunsByWorkspaceId(
    ...
    if (workspaceId === null || workspaceId === undefined) {
      throw new Error(
        'Required parameter workspaceId was null or undefined when calling getRunsByWorkspaceId.'
      );
    }
  ...
  public rejectRun(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling rejectRun.'
      );
    }
  ...
  public saveState(
    ...
    if (runId === null || runId === undefined) {
      throw new Error(
        'Required parameter runId was null or undefined when calling saveState.'
      );
    }
