...
export class UsersService {
  ...
  public getUsersWithPermission(
    ...
    if (permissionId === null || permissionId === undefined) {
      throw new Error(
        'Required parameter permissionId was null or undefined when calling getUsersWithPermission.'
      );
    }
    ...
    return this.httpClient.get<Array<User>>(
      ...
      }/api/users/permissions/${encodeURIComponent(
        String(permissionId)
      )}/users`,
      {
        withCredentials: this.configuration.withCredentials,
