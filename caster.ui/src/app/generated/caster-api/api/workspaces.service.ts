...
export class WorkspacesService {
  ...
  public createWorkspace(
    ...
    return this.httpClient.post<Workspace>(
      `${this.configuration.basePath}/api/workspaces`,
  ...
  public deleteWorkspace(
    ...
    return this.httpClient.delete<Workspace>(
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public disableWorkspaceLocking(
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<boolean>;
  public disableWorkspaceLocking(
  ...
  public disableWorkspaceLocking(
    ...
    return this.httpClient.post<boolean>(
      `${this.configuration.basePath}/api/workspaces/actions/disable-locking`,
      null,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public editWorkspace(
    id: string,
    EditWorkspaceCommand?: EditWorkspaceCommand,
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<Workspace>;
  public editWorkspace(
  ...
  public editWorkspace(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling editWorkspace.'
      );
    }
  ...
  public enableWorkspaceLocking(
    ...
    return this.httpClient.post<boolean>(
      `${this.configuration.basePath}/api/workspaces/actions/enable-locking`,
      null,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getWorkspaceLockingStatus(
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<boolean>;
  public getWorkspaceLockingStatus(
  ...
  public getWorkspaceLockingStatus(
    ...
    return this.httpClient.get<boolean>(
      `${this.configuration.basePath}/api/workspaces/locking-status`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  public getWorkspaces(
    ...
    return this.httpClient.get<Array<Workspace>>(
      `${this.configuration.basePath}/api/workspaces`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getWorkspacesByProjectId(
    directoryId: string,
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<Array<Workspace>>;
  ...
  public getWorkspacesByProjectId(
    ...
    if (directoryId === null || directoryId === undefined) {
      throw new Error(
        'Required parameter directoryId was null or undefined when calling getWorkspacesByProjectId.'
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public partialEditWorkspace(
    id: string,
    PartialEditWorkspaceCommand?: PartialEditWorkspaceCommand,
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<Workspace>;
  public partialEditWorkspace(
  ...
  public partialEditWorkspace(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling partialEditWorkspace.'
      );
    }
