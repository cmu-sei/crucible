...
{
    public interface IConnectionService : IHostedService
    {
    ...
    public class ConnectionService : IConnectionService
    {
        ...
        private async Task LoadCache()
        {
            ...
            var props = new PropertySpec[]
            {
                ...
                {
                    type = "VirtualMachine",
                    pathSet = new string[] { "name", "summary.config.uuid" }
                },
            ...
            LoadMachineCache(response.returnval.FindType("VirtualMachine"));
        ...
        private void LoadMachineCache(NetVimClient.ObjectContent[] virtualMachines)
        {
            ...
            foreach (var vm in virtualMachines)
            {
                ...
                try
                {
                    ...
                    var idObj = vm.GetProperty("summary.config.uuid");
