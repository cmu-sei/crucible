...
If you are developing within the [Crucible Framework](https://github.com/cmu-sei/crucible) or building an application to work alongside the Crucible Framework, please consider contributing documentation to this repository. The documentation in this repository uses Markdown. The static site generator used to display it is [Material for MkDocs](https://squidfunk.github.io/mkdocs-material/) and [GitHub Pages](https://pages.github.com/) hosts the documentation.
...
5. Click the green **Open in Browser** button to see the Crucible Documentation site in a new tab. As long as you don't cancel the command in the terminal, the docs site automatically updates any time you change `mkdocs.yml` or any file in the `docs/` directory.
...
5. If required, update the navigation by modifying the `mkdocs.yml` file to add new sections under the `nav:`header. Place any sub-sections in their respective subdirectories to keep the docs organized.
...
When you feel confident about your documentation and want to contribute back to the main Crucible project, open a Pull Request. A Crucible maintainer will review your contribution. Thank you!
