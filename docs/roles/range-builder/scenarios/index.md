...
!!! abstract "SEI Digital Library"
    ...
    For deeper insights on assessment and scenario evaluation, see [Self-Assessment in Training and Exercise](https://sei.cmu.edu/library/self-assessment-in-training-and-exercise/).
