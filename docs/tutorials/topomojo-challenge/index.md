...
3. In the **Answer** field, enter `##token1##`. We use the "double-pound" notation because we want to reference the transform value in the answer. This double-pound syntax performs variable replacement when a *gamespace* is deployed.
