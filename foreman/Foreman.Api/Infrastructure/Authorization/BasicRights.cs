...
namespace Foreman.Api.Infrastructure.Authorization
{
    ...
    public class BasicRightsHandler : AuthorizationHandler<BasicRightsRequirement>, IAuthorizationHandler
    {
        ...
        {        
            // TODO: remove this override when we really implement claims
            // always grant claim until we really implement claims
