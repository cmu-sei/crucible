...
using Foreman.Core.Infrastructure.Comparers;

namespace Foreman.Core.Infrastructure.Extensions
{
    public static class StringExtensions
    {
        ...
        // public static string Key(this Steamfitter.Api.Data.Entity item)
        // {
        //     Type T = item.GetType();
        //     if (T.BaseType != typeof(Steamfitter.Api.Data.Entity))
        //         T = T.BaseType;
