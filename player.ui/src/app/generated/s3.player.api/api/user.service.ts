...
export class UserService {
    ...
    public addUserToTeam(teamId: string, userId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.configuration.basePath}/teams/${encodeURIComponent(String(teamId))}/users/${encodeURIComponent(String(userId))}`,
            null,
            {
    ...
    public broadcastToUser(viewId: string, userId: string, incomingData?: Notification, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<any> {
        ...
        return this.httpClient.post<string>(`${this.configuration.basePath}/views/${encodeURIComponent(String(viewId))}/users/${encodeURIComponent(String(userId))}/notifications`,
            incomingData,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
    ...
    public getTeamUsers(id: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<any> {
        ...
        return this.httpClient.get<Array<User>>(`${this.configuration.basePath}/teams/${encodeURIComponent(String(id))}/users`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public getViewUsers(id: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<any> {
        ...
        return this.httpClient.get<Array<User>>(`${this.configuration.basePath}/views/${encodeURIComponent(String(id))}/users`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public removeUserFromTeam(teamId: string, userId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.configuration.basePath}/teams/${encodeURIComponent(String(teamId))}/users/${encodeURIComponent(String(userId))}`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
